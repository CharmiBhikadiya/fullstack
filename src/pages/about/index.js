...
export default function AboutPage({skills}) {
    ...
    <Grid container spacing={2}>
        <Grid item md={6}>
            ...
            <p>I&aposm a Frontend Web Developer building the Front-end of Websites and Web Applications that leads to the success of the overall product. Check out some of my work in the Projects section.</p>
            ...
            <p>I&aposm open to Job opportunities where I can contribute, learn and grow. If you have a good opportunity that matches my skills and experience then don&apost hesitate to contact me.</p>
            <Button 
            variant='contained' 
            size='large' 
...
export async function getStaticProps (){
    ...
    try {
        const response = await fetch('https://charmi-skills-api-default-rtdb.firebaseio.com/skills.json')
